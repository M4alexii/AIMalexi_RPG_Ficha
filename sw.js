...
const PRECACHE_URLS = [
  ...
  "./js/views/chat.js",
  "./js/views/dependencies.js",
  "./js/views/dashboard.js",
  "./js/views/journal.js",
  "./js/views/spells.js",
  "./js/views/tomes.js",
  "./js/views/combat.js",
  "./js/views/background.js",
  "./js/views/finances.js",
  "./js/views/identity.js",
  "./js/views/attributes.js",
  "./js/views/wizard.js",
  "./js/investigator.js",
  "./js/keeper.js",
  "./js/keeper-tabs.js",
  ...
  "./js/campaign/campaign-persistence.js",
  "./js/campaign/outbox-indexeddb.js",
  "./js/campaign/supabase-persistence-adapter.js",
  "./js/campaign/campaign-sync.js",
];
